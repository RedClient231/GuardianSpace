...
Java_com_tools_vspace_engine_1patch_GG_1Patcher_nativeHookGG(
...
extern "C" JNIEXPORT void JNICALL
Java_com_tools_vspace_engine_1patch_GG_1Patcher_nativeApplyTimeHook(
...
extern "C" JNIEXPORT void JNICALL
Java_com_tools_vspace_engine_1patch_GG_1Patcher_nativeUnhookGG(
    JNIEnv *env, jobject thiz, jstring packageName) {
    const char *pkg = env->GetStringUTFChars(packageName, nullptr);
...
Java_com_tools_vspace_engine_1patch_GG_1Patcher_nativeInit(
    JNIEnv *env, jobject thiz, jstring packageName) {
    const char *pkg = env->GetStringUTFChars(packageName, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_com_tools_vspace_engine_1patch_GG_1Patcher_nativeSetSpeed(
...
Java_com_tools_vspace_engine_1patch_GG_1Patcher_nativeIsHooked(
    JNIEnv *env, jobject thiz) {
    return JNI_TRUE;
}
...
Java_com_tools_vspace_engine_1patch_GG_1Patcher_nativeGetVersion(
    JNIEnv *env, jobject thiz) {
